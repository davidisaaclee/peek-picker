...
gulp.task('coffee', function () {
  var bundle = browserify(_.extend(options.coffee.options, {
    entries: './peek-picker.coffee',
    outputName: 'peek-picker.js',
    transform: [coffeeify]
  })).bundle();
...
gulp.task('demo_script', function () {
  var bundle = browserify(_.extend(options.coffee.options, {
    entries: './demo/peek-picker-demo.coffee',
    outputName: 'peek-picker-demo.js',
    transform: [coffeeify]
  })).bundle();
  ...
  return bundle
    .pipe(source('peek-picker-demo.js'))
    .pipe(buffer())
